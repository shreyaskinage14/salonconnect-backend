...
def get_url():
    ...
    return os.getenv("DATABASE_URL", os.getenv("DATABASE_URL", "postgresql://salon:u7LK1FC4yLg2Joc8qNwnch3UPNjTMfuq@dpg-d68cvn3h46gs73fd84qg-a.virginia-postgres.render.com/salon_db_cz7z"))
